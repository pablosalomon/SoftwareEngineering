...
public class Cliente {
    ...
    public static void main(String [ ] args) {
    	...
    	Sensor sa = empresa.crearSensor("Temperature",2.3, 6.0);
    	...
    	Sensor sb = empresa.crearSensor("Pression", 1.3, 5.8);
    	...
    	Sensor sc = empresa.crearSensor("Temperature",3.2, 6.0);
    	sc.setState("440", 323.1, "Kelvin");
    	Sensor sd = empresa.crearSensor("Temperature",2.3, 5.6);
